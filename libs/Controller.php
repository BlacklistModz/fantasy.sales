...
class Controller {
    ...
    public function handleLogin(){
        ...
        $me = $this->model->query('sales')->get( Cookie::get( COOKIE_KEY_EMP ) );
            $dep = "Sales";
    ...
    public function login() {
        ...
        $this->view->setPage('title',  !empty($this->system['title']) ? $this->system['title'] : "Modern Fantasy" );
    ...
    public function _modify() {
        ...
        $this->view->js('jquery.stayInWebApp.min');
        $this->view->setPage('theme', $this->system['theme']);
